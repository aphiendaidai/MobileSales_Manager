...
import Mobile_manager.CTL.PhanQuyenCTL;
import Mobile_manager.Model.PhanQuyen;

public class MainQuanLyView extends JFrame {

    public MainQuanLyView() {
        this.setTitle("Phần mềm quản lý cửa hàng điện thoại di động");
...
//        pnTitle.add(lblTitleText);
        JLabel lblTitleText = new JLabel("Quản Lý Cửa Hàng Bán Điện Thoại"); // Thay "Your Text Here" bằng văn bản bạn muốn hiển thị
        lblTitleText.setBounds(width / 2 - 428 / 2, 3, 428, 38);
        lblTitleText.setFont(new Font("Arial", Font.BOLD, 24)); // Tùy chỉnh phông chữ và cỡ chữ
        lblTitleText.setForeground(Color.WHITE); // Tùy chỉnh màu sắc của văn bản
        pnTitle.add(lblTitleText);
        ...
        //======XỬ LÝ PHÂN QUYỀN=======
        PhanQuyen quyen = PhanQuyenCTL.quyenTK;

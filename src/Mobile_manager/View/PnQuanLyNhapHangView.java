...
public class PnQuanLyNhapHangView extends javax.swing.JPanel {
    ...
    private SanPhamCTL sanPhamBUS = new SanPhamCTL();
    private NhanVienCTL nhanVienBUS = new NhanVienCTL();
    private PhieuNhapCTL phieuNhapBUS = new PhieuNhapCTL();
    private CTPhieuNhapCTL ctPhieuNhapBUS = new CTPhieuNhapCTL();
    ...
    private void initComponents() {
        ...
        btnResetKho.setIcon(new javax.swing.ImageIcon("image/Refresh-icon.png")); // NOI18N
        ...
        btnTimKiem.setIcon(new javax.swing.ImageIcon("image/Search-icon.png")); // NOI18N
        ...
        btnThemVaoGio.setIcon(new javax.swing.ImageIcon("image/check-icon.png")); // NOI18N
        ...
        btnXoaKhoiGio.setIcon(new javax.swing.ImageIcon("image/delete-icon.png")); // NOI18N
        ...
        btnXacNhan.setIcon(new javax.swing.ImageIcon("image/check-icon.png")); // NOI18N
        ...
        btnResetTabXemLai.setIcon(new javax.swing.ImageIcon("image/Refresh-icon.png")); // NOI18N
